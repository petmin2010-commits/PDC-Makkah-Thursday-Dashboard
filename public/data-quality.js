...
function definitions(q){
 return [
  ...
  {key:'assets',title:'الأصول',subtitle:'🏭 الأصول',rows:q.assets||[],cards:[
   custom('بدون تاريخ تركيب المعدة','I','تاريخ تركيب المعدة','العمود I — يُحتسب ناقصًا إذا كانت هناك حالة مدخلة في K «مراجعة بيانات الزراعة»',r=>!!t(r.plantingReview)&&blank(r,'installDate'),()=> 'فارغ'),
   custom('بدون اسم مهندس التركيب','J','اسم المهندس المسئول عن التركيب','العمود J — يُحتسب ناقصًا إذا كانت هناك حالة مدخلة في K «مراجعة بيانات الزراعة»',r=>!!t(r.plantingReview)&&blank(r,'engineer'),()=> 'فارغ'),
